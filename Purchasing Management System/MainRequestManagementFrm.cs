...
namespace Purchasing_Management_System
{
    public partial class MainRequestManagementFrm : Form
    {
        ...
        {
            InitializeComponent();
            btnSummary.MouseEnter += new EventHandler(button_MouseEnter);
            btnSummary.MouseLeave += new EventHandler(button_MouseLeave);
            btnDetails.MouseEnter += new EventHandler(button_MouseEnter);
            btnDetails.MouseLeave += new EventHandler(button_MouseLeave);
        }
